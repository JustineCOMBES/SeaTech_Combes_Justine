...
AD1CON2bits.SMPI = 4; // 2+1 conversions successives avant interrupt - 4 pour 5 entrées
AD1CON2bits.ALTS = 0;
AD1CON2bits.BUFM = 0;
...
/************************************************************/
//ADC utilisés : 16(G9) pin 8 - 11(C11) pin 24 - 6(C0) pin 21
ANSELCbits.ANSC0 = 1;
ANSELCbits.ANSC11 = 1;
ANSELGbits.ANSG9 = 1;
// -sup ++++++++++++++++++++++++++ 15 (E15) et 3 (B1)
...
ADCResult[3] = ADC1BUF3;// Read the AN7 conversion result
ADCResult[4] = ADC1BUF4;// Read the AN9 conversion result
